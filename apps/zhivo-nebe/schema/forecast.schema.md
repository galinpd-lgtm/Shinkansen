...
- `agreement` брои само източниците, които дават величината, определила риска за деня,
  и сами стигат точно до същото ниво.
- `confidence` зависи от броя източници, които сами стигат поне до нивото на риска (за нисък риск — до нисък):
  един или нито един → `low`; поне три и поне 60 % от гласуващите → `high`; иначе `medium`.
